(function() {
  ...
  const MapManager = {
    ...
    displayArea: function(area) {
      ...
      areaElement.style.bottom = '10px';
      areaElement.style.left = '10px';
      areaElement.style.backgroundColor = 'rgba(255, 255, 255, 0.8)';
      areaElement.style.padding = '10px';
      areaElement.style.borderRadius = '5px';
      areaElement.style.fontFamily = 'Arial, sans-serif';
      areaElement.style.fontSize = '14px';
      areaElement.style.zIndex = '1000';
    ...
    setupFieldSelection: function() {
      ...
      if (addFieldBtn) {
        addFieldBtn.addEventListener('click', function(e) {
          e.preventDefault();
          AgriManage.showNotification('Функция добавления поля в разработке', 'info');
        });
      }
    },
